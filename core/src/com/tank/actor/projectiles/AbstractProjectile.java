...
public abstract class AbstractProjectile extends Actor implements Collidable, Destructible{
	...
	protected Texture tex;				//The texture of the projectile
	protected Vector2 velocity;			//The velocity of the projectile, giving direction and speed
	protected AbstractVehicle source;	//The source of the projectile, from some tank
	protected Stats stats;				//The stats of the projectile, which includes damage and such

	/**
	 * The AbstractProjectile constructor to define all the standard instance variables
	 * 
	 * @param t			The texture of the projectile
	 * @param stat		The stat of the projectile
	 * @param src		The source the projectile came from
	 * @param x			The starting x of the projectile
	 * @param y			The starting y of the projectile
	 */
	...
	/**
	 * The updateVelocityAndMove method is called the the act method that updates the velocity every call.
	 */
	...
	/**
	 * The applyForce method is used to instantly change the velocity of the projectile
	 * 
	 * @param acceleration		The force to add to the velocity
	 */
	 ...
	 * 
	 * @param wall		The vector of the wall
	 */
