...
public class Loading extends Stage implements InputProcessor {
	...
	static {
		facts = new String[] {"Canada is the second largest country in the world, right after Russia.", 
        		...
        		"The Landminer is a small, black enemy tank that can drop landmines. These are very dangerous, so either avoid them or destroy them from afar.",
        		"The Bigshot is a square shaped, teal colored enemy tank that fires slow, high-damage Rockets. They also have high armor.",
        		...
        		"There are no assists--only the player whose projectile destroys the enemy will gain exp.",
        		"Projectiles are not 100% accurate when you shoot them. The accuracy goes down even more when on the move.",
        		"Fewer items will spawn if you take too long on a level.",
        		...
        		"The number of Moose, Caltrops, and Pellets that are fired per shot is dependent on your max projectile count.",
        		...
        		"You shoot much less accurately if you are moving around. Use the Stability upgrade to shoot more accurately while on the move.",
        		"Ironically, the Rocket is the best weapon against Bigshots, and the Artillery is the best weapon against Artillery Tanks.",
        		"Having more players doesn't make enemy tanks stronger or increase their numbers. You just have to EXP ration correctly.",
