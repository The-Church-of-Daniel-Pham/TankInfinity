...
public class Loading extends Stage implements InputProcessor {
	...
	static {
		facts = new String[] {"Canada is the second largest country in the world, right after Russia.", 
        		...
        		"The Peashooter is a light-tan small enemy tank that doesn't rotate its gun. It is the most common enemy in the game.",
        		...
        		"The Landminer is a black small enemy tank that can drop landmines. These are very dangerous, so either stay away or destroy them from afar.",
        		"The Bigshot is a teal square enemy tank that fires Rockets. These Rockets move rather slowly but deal heavy damage",
        		...
        		"The Anti-Bullet Wall blocks all projectiles going through it, but not explosions. It's not invincible however, just a really large amount of durability.",
        		...
        		"Accuracy and Spread are slightly different. Accuracy increases the chance of a bullet going down the line, Spread is the variable range of a bullet angle.",
        		"You shoot much less accurately if you are moving around. Use the Stability upgrade if you like to move and shoot around for more accuracte shots.",
