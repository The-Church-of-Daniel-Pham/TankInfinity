...
public class Assets {
	...
	// Textures
	// Floor
	public static final AssetDescriptor<Texture> grass0 = new AssetDescriptor<Texture>("map/grass0.png", Texture.class);
	public static final AssetDescriptor<Texture> grass1 = new AssetDescriptor<Texture>("map/grass1.png", Texture.class);
	public static final AssetDescriptor<Texture> grass2 = new AssetDescriptor<Texture>("map/grass2.png", Texture.class);
	public static final AssetDescriptor<Texture> grass3 = new AssetDescriptor<Texture>("map/grass3.png", Texture.class);
	public static final AssetDescriptor<Texture> grass4 = new AssetDescriptor<Texture>("map/grass4.png", Texture.class);
	// Wall
	public static final AssetDescriptor<Texture> stone0 = new AssetDescriptor<Texture>("map/stone0.png", Texture.class);
	public static final AssetDescriptor<Texture> stone1 = new AssetDescriptor<Texture>("map/stone1.png", Texture.class);
	public static final AssetDescriptor<Texture> stone2 = new AssetDescriptor<Texture>("map/stone2.png", Texture.class);
	public static final AssetDescriptor<Texture> stone3 = new AssetDescriptor<Texture>("map/stone3.png", Texture.class);
	public static final AssetDescriptor<Texture> stone4 = new AssetDescriptor<Texture>("map/stone4.png", Texture.class);
	// Portal
	...
	public static final AssetDescriptor<Texture> landMine = new AssetDescriptor<Texture>("projectiles/landMine.png",
			Texture.class);
	// Tank
	public static final AssetDescriptor<Texture> tread_default = new AssetDescriptor<Texture>(
			"tank/tank_tread_default.png", Texture.class);
	...
	public static final AssetDescriptor<Texture> gun_green = new AssetDescriptor<Texture>("tank/tank_gun_green.png",
			Texture.class);
	public static final AssetDescriptor<Texture> tread_yellow = new AssetDescriptor<Texture>(
			"tank/tank_tread_yellow.png", Texture.class);
	public static final AssetDescriptor<Texture> gun_yellow = new AssetDescriptor<Texture>("tank/tank_gun_yellow.png",
			Texture.class);
	public static final AssetDescriptor<Texture> tread_purple = new AssetDescriptor<Texture>(
			"tank/tank_tread_purple.png", Texture.class);
	...
	public static final AssetDescriptor<Texture> gun_tan = new AssetDescriptor<Texture>("tank/tank_gun_tan.png",
			Texture.class);
	// Items
	public static final AssetDescriptor<Texture> box = new AssetDescriptor<Texture>("item/box.png", Texture.class);
	// UI
	public static final AssetDescriptor<Texture> crosshairs_default = new AssetDescriptor<Texture>(
			"ui/cursor/crosshairs_default.png", Texture.class);
	public static final AssetDescriptor<Texture> crosshairs_red = new AssetDescriptor<Texture>(
			"ui/cursor/crosshairs_red.png", Texture.class);
	public static final AssetDescriptor<Texture> crosshairs_blue = new AssetDescriptor<Texture>(
			"ui/cursor/crosshairs_blue.png", Texture.class);
	public static final AssetDescriptor<Texture> crosshairs_green = new AssetDescriptor<Texture>(
			"ui/cursor/crosshairs_green.png", Texture.class);
	public static final AssetDescriptor<Texture> crosshairs_yellow = new AssetDescriptor<Texture>(
			"ui/cursor/crosshairs_yellow.png", Texture.class);
	public static final AssetDescriptor<Texture> crosshairs_purple = new AssetDescriptor<Texture>(
			"ui/cursor/crosshairs_purple.png", Texture.class);
	public static final AssetDescriptor<Texture> crosshairs_tan = new AssetDescriptor<Texture>(
			"ui/cursor/crosshairs_tan.png", Texture.class);
	public static final AssetDescriptor<Texture> tank_preview_default = new AssetDescriptor<Texture>(
			"ui/tank/tank_preview_default.png", Texture.class);
	public static final AssetDescriptor<Texture> tank_preview_red = new AssetDescriptor<Texture>(
			"ui/tank/tank_preview_red.png", Texture.class);
	public static final AssetDescriptor<Texture> tank_preview_blue = new AssetDescriptor<Texture>(
			"ui/tank/tank_preview_blue.png", Texture.class);
	public static final AssetDescriptor<Texture> tank_preview_green = new AssetDescriptor<Texture>(
			"ui/tank/tank_preview_green.png", Texture.class);
	public static final AssetDescriptor<Texture> tank_preview_yellow = new AssetDescriptor<Texture>(
			"ui/tank/tank_preview_yellow.png", Texture.class);
	public static final AssetDescriptor<Texture> tank_preview_purple = new AssetDescriptor<Texture>(
			"ui/tank/tank_preview_purple.png", Texture.class);
	public static final AssetDescriptor<Texture> tank_preview_tan = new AssetDescriptor<Texture>(
			"ui/tank/tank_preview_tan.png", Texture.class);
	// Menu
	public static final AssetDescriptor<Texture> backdrop = new AssetDescriptor<Texture>("menu/loading/backdrop.png",
			Texture.class);
	public static final AssetDescriptor<Texture> loading_tank = new AssetDescriptor<Texture>(
			"menu/loading/loading_tank.png", Texture.class);
	...
	public static final AssetDescriptor<Texture> black = new AssetDescriptor<Texture>("menu/pause/black.png",
			Texture.class);
	public static final AssetDescriptor<Texture> red = new AssetDescriptor<Texture>("menu/gameover/red.png",
			Texture.class);
	// Debug
