...
public class XboxMapping {
    ...
    public static final int AXIS_LEFT_TRIGGER = 4; //changed to match school computers
    public static final int AXIS_RIGHT_X = 3; //-1 is left | +1 is right
    public static final int AXIS_RIGHT_Y = 2; //-1 is up | +1 is down
    public static final int AXIS_RIGHT_TRIGGER = 5; //change to match school computers
}